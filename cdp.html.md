...
Attach to a running Chrome with
[`cdp_connect()`](https://vedicreader.github.io/fossick/cdp.html#cdp_connect).
`pg.snapshot()` gives an agent a compact a11y map; `fill_form` / `act`
drive it. Network capture + replay for hidden APIs.
...
*Open `url` as an app window – no tabs, no address bar – in the
persistent debug Chrome.*

------------------------------------------------------------------------

<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L64"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L57"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L92"
target="_blank" style="float:right; font-size:smaller">source</a>
...
Upgrades fastcdp’s `eval` in three ways every caller wants: promises are
awaited, objects and arrays come back as Python values instead of
`None`, and a JS exception is raised as
[`JSError`](https://vedicreader.github.io/fossick/cdp.html#jserror)
rather than silently read as an empty result.

------------------------------------------------------------------------

<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L89"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L107"
target="_blank" style="float:right; font-size:smaller">source</a>
...
`cdp_install` / keep-alive launch a persistent profile. Cookies survive
restarts.
...
[`cdp_app`](https://vedicreader.github.io/fossick/cdp.html#cdp_app)
opens a headed app window on the persistent profile.
...
<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L114"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L151"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L183"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L178"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L173"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L228"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L221"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L215"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L207"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L279"
target="_blank" style="float:right; font-size:smaller">source</a>
...
``` python
async def eval_json(
    page:Page, fn:str, *args
):
```

*Call JavaScript function `fn` with JSON-safe `args`, returning its
decoded result.*

------------------------------------------------------------------------

<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L272"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L265"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L256"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L247"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L286"
target="_blank" style="float:right; font-size:smaller">source</a>
...
`snapshot`, `click`, `fill`, `act`, `md`, high-level ops over the a11y
tree.
...
<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L341"
target="_blank" style="float:right; font-size:smaller">source</a>
...
![](01_cdp_files/figure-commonmark/cell-39-output-2.png)

------------------------------------------------------------------------

<a
href="https://github.com/vedicreader/fossick/blob/main/fossick/cdp.py#L467"
target="_blank" style="float:right; font-size:smaller">source</a>
...
![](01_cdp_files/figure-commonmark/cell-41-output-2.png)
