...
# %% auto #0
__all__ = ['http_get', 'http_post', 'save_path', 'get_pdf', 'read_arxiv', 'read_gh_repo', 'read_gh_file', 'clean_md', 'html2md',
           'to_md', 'fetch', 'crawl', 'get_options', 'fetch_all', 'compile_pattern', 'find_xhr', 'paginate_api',
           'search_yt', 'read_yt', 'download_yt', 'repo_root', 'mv_skill_md']
