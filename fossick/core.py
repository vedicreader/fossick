...
# %% auto #0
__all__ = ['http_get', 'http_post', 'fossick_cache', 'html2md', 'to_md', 'http_page', 'get_page', 'fetch', 'crawl', 'get_options',
           'fetch_all', 'get_pdf', 'read_arxiv', 'lookup_doi', 'clean_md', 'ocr_parse', 'pdf2md', 'url2nb', 'pdf2nb',
           'read_gh_repo', 'read_gh_file', 'compile_pattern', 'find_xhr', 'paginate_api', 'download_files', 'search_yt',
...
def http_page(url, method='GET', payload=None, **kw) -> Response:
...
http_get = bind(get_page, method='GET', timeout=30)
