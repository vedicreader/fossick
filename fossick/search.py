...
# %% auto #0
__all__ = ['TEXT_BACKENDS', 'text', 'images', 'news', 'videos', 'books', 'ddgs_env', 'get_ddgs', 'backends', 'norm_url', 'rrf',
           'bm25', 'flashrank_scores', 'rerank', 'search', 'extract', 'google', 'usable', 'focus', 'research']
...
def _backend_lists(q:str, backends, region='us-en', timeout=8, pages=1) -> list:
    ...
    if not jobs: return []
    got = parallel(lambda j: (j, _engine_hits(j[0], q, region=region, page=j[1], timeout=timeout)),
